...
describe('latLonToTileCoords', function() {
  it('should return the correct tile coordinates for maximum latitude and longitude', async function() {
  ...
  it('should return the correct tile coordinates for minimum latitude and longitude', async function() {
    const chai = await import('chai');
    const expect = chai.expect;
  ...
  it('should return the correct tile coordinates for coordinates near the International Date Line', async function() {
    const chai = await import('chai');
    const expect = chai.expect;
  ...
  it('should return the correct tile coordinates for extreme latitude with negative longitude', async function() {
    const chai = await import('chai');
    const expect = chai.expect;
  ...
  it('should return the correct tile coordinates for extreme latitude with positive longitude', async function() {
    const chai = await import('chai');
    const expect = chai.expect;
